...
- Add `examples/g1-constraint-simulation.py`: complex example of a simulation of a g1 under multiple constraints (joint limits, joint frictions and point anchors)
