...
#endif // PINOCCHIO_LSP
```
Where `xxx[1-N].hxx` are needed private headers. Since there are no transitive include,
[IWYU](https://include-what-you-use.org/) (included in clangd) will help debug useless include.
