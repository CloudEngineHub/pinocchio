...
// IWYU pragma: private, include "pinocchio/codegen/cppadcg-algo.hpp"
    ...
    Eigen::Index constraintDim(const ContactModelVector & contact_models) const
    {
           ...
           it != contact_models.end(); ++it)
      {
        PINOCCHIO_CHECK_INPUT_ARGUMENT(
          it->residualSize() > 0, "The dimension of the constraint must be positive");
        num_total_constraints += it->residualSize();
      }
