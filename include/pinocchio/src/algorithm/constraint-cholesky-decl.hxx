...
// Because of a GCC bug we should NEVER define a function that use ConstraintCholeskyDecompositionTpl
...
// explicit template instantiation of the ConstraintCholeskyDecompositionTpl class.
