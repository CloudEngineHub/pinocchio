...
namespace pinocchio
{
  ...
  protected:
    ...
    ///
    /// \returns true if a new allocation was performed, false if existing capacity was sufficient.
    ///
  ...
  public:
    ...
    ///
    /// \details Stores only the diagonal elements of the input diagonal matrix as a column vector.
    /// This is a space-efficient representation since diagonal matrices only have non-zero
