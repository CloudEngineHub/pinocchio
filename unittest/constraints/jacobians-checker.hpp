...
namespace pinocchio
{
  ...
  {
    Data::MatrixXs J_ref = Data::MatrixXs::Zero(cmodel.residualSize(cdata), model.nv);
    ...
    for (int k = 0; k < num_tests; ++k)
    {
      ...
      const Data::MatrixXs mat_transpose = Data::MatrixXs::Random(cmodel.residualSize(cdata), m);
