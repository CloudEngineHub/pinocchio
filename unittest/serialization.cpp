...
//     ConstraintModel cmodel =
//     PointAndFrameConstraintModelInitializer<ConstraintModel>::run(model); return cmodel;
//   }
// };
...
//   static ConstraintModel run(const Model & model)
//   {
//     // Note: For PointContact constraints, the friction coeff of the coulomb cone needs to
//     be
//     // set.
//     ConstraintModel cmodel =
//     PointAndFrameConstraintModelInitializer<ConstraintModel>::run(model);
...
//   {
//     JointLimitConstraintModel cmodel_ =
//     initConstraint<JointLimitConstraintModel>::run(model); ConstraintModel
//     cmodel(cmodel_); ConstraintData cdata(cmodel.createData()); cmodel.calc(model, data,
//     cdata);
...
//   }
//   {
//     JointFrictionConstraintModel cmodel_ =
//     initConstraint<JointFrictionConstraintModel>::run(model); ConstraintModel
//     cmodel(cmodel_); ConstraintData cdata(cmodel.createData()); cmodel.calc(model, data,
//     cdata);
...
//   }
//   {
//     PointContactConstraintModel cmodel_ =
//     initConstraint<PointContactConstraintModel>::run(model); ConstraintModel
//     cmodel(cmodel_); ConstraintData cdata(cmodel.createData()); cmodel.calc(model, data,
//     cdata);
...
//   }
//   {
//     PointAnchorConstraintModel cmodel_ =
//     initConstraint<PointAnchorConstraintModel>::run(model); ConstraintModel
//     cmodel(cmodel_); ConstraintData cdata(cmodel.createData()); cmodel.calc(model, data,
//     cdata);
...
//   }
//   {
//     FrameAnchorConstraintModel cmodel_ =
//     initConstraint<FrameAnchorConstraintModel>::run(model); ConstraintModel
//     cmodel(cmodel_); ConstraintData cdata(cmodel.createData()); cmodel.calc(model, data,
//     cdata);
